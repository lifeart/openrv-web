...
export const MODULE_CONFIGS: ModuleConfig[] = [
  // === 5.3.1: Core -- IPImage ===
  {
    ...
    sourceFiles: [
      ...
      'src/core/image/ManagedVideoFrame.ts',
    ],
    category: 'core',
    outputName: 'ip-image',
  },
  ...
  // === 5.3.8: Color -- Curves and Color Wheels ===
  {
    ...
    template: 'user-guide',
    sourceFiles: [
      'src/color/ColorCurves.ts',
      'src/color/HueRotation.ts',
      'src/color/ColorWheelsNode.ts',
    ],
    category: 'color',
  ...
  // === 5.3.12: Format -- HDR/JXL/JP2 ===
  {
    ...
    template: 'user-guide',
    sourceFiles: [
      'src/formats/HDRDecoder.ts',
      'src/formats/JXLDecoder.ts',
      'src/formats/JP2Decoder.ts',
    ],
    category: 'formats',
  ...
  // === 5.3.16: Node -- Source Nodes ===
  {
    ...
    template: 'user-guide',
    sourceFiles: [
      'src/nodes/FileSourceNode.ts',
      'src/nodes/VideoSourceNode.ts',
    ],
    category: 'nodes',
  ...
  // === 5.3.29: Plugins -- Plugin System (architecture) ===
  {
    ...
    sourceFiles: [
      ...
      'src/plugins/ExporterRegistry.ts',
    ],
    category: 'plugins',
