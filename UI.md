...
ExportControl, FalseColorControl. Both follow the Pattern B template and were not in the original Phase 3 complex-control list; they are simple enough to migrate alongside the remaining Phase 2 controls if the Phase 2 commit's scope was incomplete.
