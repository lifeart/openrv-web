...
NetworkControl, HSLQualifierControl, DisplayProfileControl (batch 1); LuminanceVisualizationControl, MultiSourceLayoutControl, GamutMappingControl (batch 2).

**Known follow-up (still unmigrated controls — Phase 3 / complex Escape behavior)**:
AutoSaveIndicator, ExportControl, FalseColorControl, LUTPipelinePanel, OCIOControl, PerspectiveCorrectionControl, StackControl, StereoEyeTransformControl, TimelineContextMenu, TimelineEditor.
