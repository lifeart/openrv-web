...
describe('DecoderRegistry', () => {
  ...
  // =========================================================================
  // Issue #147: MXF removed from still-image decoder registry
  // =========================================================================
  describe('issue #147: MXF not in decoder registry', () => {
    it('DR-MXF-001: MXF is not detected by the still-image decoder registry', () => {
