...
/**
 * Sets all viewer uniforms to identity/passthrough values.
 * Identical to the linearize test helper — repeated here to keep files self-contained.
 */
function setupIdentityPipeline(gl: WebGL2RenderingContext, program: WebGLProgram) {
  ...
  gl.uniform1i(gl.getUniformLocation(program, 'u_outputMode'), 1); // HDR passthrough
