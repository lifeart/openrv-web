  ...
  describe('Main thread -> Worker message types', () => {
    ...
    it('RWM-021: all message types are distinguishable by type field', () => {
      ...
      const messages: RenderWorkerMessage[] = [
        ...
        { type: 'setHighlightsShadows', state: { highlights: 0, shadows: 0, whites: 0, blacks: 0 } },
        { type: 'setVibrance', state: { vibrance: 0, skinProtection: false } },
        { type: 'setClarity', state: { clarity: 0 } },
        { type: 'setSharpen', state: { amount: 0 } },
  ...
  describe('RendererSyncState', () => {
    ...
    it('RWM-032: full sync state includes all fields', () => {
      const state: RendererSyncState = {
        ...
        lookLUT: { lutData: null, lutSize: 0, intensity: 0 },
        fileLUT: { lutData: null, lutSize: 0, intensity: 0 },
        displayLUT: { lutData: null, lutSize: 0, intensity: 0 },
