...
function createMinimalDeps(frameCacheController: FrameCacheController): KeyboardActionDeps {
  const noop = vi.fn();
  return {
    session: {
      currentFrame: 10,
      ...
      setOutPoint: noop,
      toggleMark: noop,
      resetInOutPoints: noop,
      goToFrame: noop,
      toggleAB: noop,
      toggleMute: noop,
      togglePlaybackMode: noop,
      noteManager: { getNextNoteFrame: noop, getPreviousNoteFrame: noop },
    },
    viewer: {
      smoothFitToWindow: noop,
      smoothFitToWidth: noop,
      smoothFitToHeight: noop,
      smoothSetZoom: noop,
      smoothSetPixelRatio: noop,
      refresh: noop,
    ...
    controls: {
      ...
      compareControl: {
        cycleWipeMode: noop,
        toggleDifferenceMatte: noop,
        toggleSplitScreen: noop,
    ...
    frameNavigation: {
      goToNextAnnotation: noop,
      goToPreviousAnnotation: noop,
      goToPlaylistStart: noop,
      goToPlaylistEnd: noop,
      goToNextMarkOrBoundary: noop,
      goToPreviousMarkOrBoundary: noop,
      goToNextShot: noop,
      goToPreviousShot: noop,
      shiftRangeToNext: () => null,
      shiftRangeToPrevious: () => null,
    },
