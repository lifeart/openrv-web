...
describe('StackControl layer button hover states', () => {
  ...
  it('SC-M28a: Layer visibility button should change style on hover', () => {
    ...
    visBtn.dispatchEvent(new MouseEvent('pointerenter'));
    expect(visBtn.style.color).toBe('var(--text-primary)');

    visBtn.dispatchEvent(new MouseEvent('pointerleave'));
  ...
  it('SC-M28b: Layer move-up button should change style on hover', () => {
    ...
    moveUpBtn.dispatchEvent(new MouseEvent('pointerenter'));
    ...
    moveUpBtn.dispatchEvent(new MouseEvent('pointerleave'));
  ...
  it('SC-M28c: Layer move-down button should change style on hover', () => {
    ...
    moveDownBtn.dispatchEvent(new MouseEvent('pointerenter'));
    ...
    moveDownBtn.dispatchEvent(new MouseEvent('pointerleave'));
  ...
  it('SC-M28d: Layer delete button should change style on hover', () => {
    ...
    deleteBtn.dispatchEvent(new MouseEvent('pointerleave'));
